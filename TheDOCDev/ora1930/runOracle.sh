...
if [ -d $ORACLE_BASE/oradata/$ORACLE_SID ]; then
  ...
  echo "database already does noet exist"
  ...
  echo "$ORACLE_BASE/$INSTALL_ORE"
  $ORACLE_BASE/$INSTALL_ORE
  echo "$ORACLE_BASE/$INSTALL_SAMPLE_SCHEMAS"
  $ORACLE_BASE/$INSTALL_SAMPLE_SCHEMAS
fi;
